...
完整規格見 [`openspec/specs/plugin-core/spec.md`](https://github.com/jim60105/HeartReverie/blob/master/openspec/specs/plugin-core/spec.md) 的「Plugin route registration」需求。
