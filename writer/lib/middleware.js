...
import { problemJson } from "./errors.js";

export function isValidParam(value) {
  return !/\.\.|\x00|[/\\]/.test(value);
}

export function createSafePath(playgroundDir) {
  return function safePath(...segments) {
...
export async function validateParams(c, next) {
...
export async function verifyPassphrase(c, next) {
