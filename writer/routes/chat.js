...
import { validateParams } from "../lib/middleware.js";
    ...
    async (c) => {
      ...
      try {
        ...
        if (!apiResponse.ok) {
          ...
          return c.json(problemJson("AI Service Error", apiResponse.status, "AI service request failed"), apiResponse.status);
        }
