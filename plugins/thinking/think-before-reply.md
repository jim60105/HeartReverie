# Think before reply
Before producing any reply, perform three thinking steps. If you have a native reasoning channel separate from the visible response, do this thinking only in that channel and do NOT repeat it in the assistant message body.
