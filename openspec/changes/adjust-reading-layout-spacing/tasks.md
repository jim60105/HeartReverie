...
- [x] 3.3 Using `agent-browser`, open `http://localhost:8080/` (passphrase `Jim605014` if prompted), navigate to any series with multi-chapter content and at least one plugin that populates the sidebar (e.g. `/櫻帝學園/日常/chapter/1`), and visually confirm:
