...
- **THEN** the file SHALL contain entries for all recognized variables: `LLM_API_KEY`, `LLM_MODEL`, `LLM_API_URL`, `LLM_TEMPERATURE`, `LLM_FREQUENCY_PENALTY`, `LLM_PRESENCE_PENALTY`, `LLM_TOP_K`, `LLM_TOP_P`, `LLM_REPETITION_PENALTY`, `LLM_MIN_P`, `LLM_TOP_A`, `PORT`, `PASSPHRASE`, `PLAYGROUND_DIR`, `READER_DIR`, `PLUGIN_DIR`, `PROMPT_FILE`, `BACKGROUND_IMAGE`
