...
Test coverage for the reader frontend's Vue components, composables, pure parser/renderer functions, hook dispatcher, and markdown rendering pipeline using Vitest and @vue/test-utils.
