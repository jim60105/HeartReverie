...
Defines the `x-actions` schema extension for plugin settings, enabling plugins to declare action buttons (e.g., connection tests) that send form data to plugin endpoints and display success/error feedback in the settings UI.
