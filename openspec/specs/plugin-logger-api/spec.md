...
Structured logging API for backend plugins, providing plugin-scoped loggers with automatic name tagging, correlation ID propagation during hook dispatch, and `baseData` support for the core logger system.
