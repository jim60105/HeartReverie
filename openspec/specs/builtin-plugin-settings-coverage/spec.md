# Builtin Plugin Settings Coverage

## Purpose

TBD — specifies the universal `enabled` toggle and settings-schema coverage requirements for every built-in plugin shipped with the core engine.
